package com.example.roadsafetyapplication.signup;
...
import com.example.roadsafetyapplication.BottomNavigationActivity;
import com.example.roadsafetyapplication.R;
import com.example.roadsafetyapplication.SignInActivity;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void createGoogleSignInRequest() {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("389177580581-bckmcvvu972ia74upkns7uj412mtku32.apps.googleusercontent.com")
                .requestEmail()
                .build();
